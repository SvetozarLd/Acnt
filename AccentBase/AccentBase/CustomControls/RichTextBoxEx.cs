...
namespace AccentBase.CustomControls
{
        public class RichTextBoxEx : RichTextBox
        {
            ...
            //[DllImport("user32.dll", EntryPoint = "Func1", CallingConvention = CallingConvention.Cdecl)]
            //private static extern int Func1_32(int var1, int var2);

            //[DllImport(@"%windir%\System32\user32.dll", EntryPoint = "Func1", CallingConvention = CallingConvention.Cdecl)]
            ...
            //}
            [DllImport(@"%windir%\System32\user32.dll", CharSet = CharSet.Auto)]
            ...
            public void InsertLink(string text, string hyperlink, int position)
            {
                ...
                this.SelectionStart = position;
                this.SelectedRtf = @"{\rtf1\ansi\ansicpg1251\deff0\deflang1049" + text + @"\v #" + hyperlink + @"\v0}";

                //this.SelectedRtf = @"{\rtf1\ansi\ansicpg1252\deff0\deflang1033 " + text + @"\v #" + hyperlink + @"\v0}";
